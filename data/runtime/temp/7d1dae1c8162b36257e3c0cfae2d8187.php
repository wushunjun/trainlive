<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:47:"themes/admin_simpleboot3/admin\index\index.html";i:1570006962;}*/ ?>
<!DOCTYPE html>
...
<head>
    ...
    <meta charset="utf-8">
    <title>微信直播 <?php echo lang('ADMIN_CENTER'); ?></title>
...
<div class="navbar navbar-default">
    <div class="container-fluid">
        <div class="navbar-header">
            <a href="<?php echo url('admin/index/index'); ?>" class="navbar-brand" style="min-width: 200px;text-align: center;">微信直播后台</a>
        ...
        <div class="navbar-collapse collapse" id="navbar-main">
            ...
            <ul class="nav navbar-nav navbar-right simplewind-nav">
                <li class="light-blue" style="border-left:none;display: none;" id="close-all-tabs-btn">
                    <a id="close-wrapper" href="javacript:void(0);" title="<?php echo lang('CLOSE_TOP_MENU'); ?>"
                ...
                <li class="light-blue dropdown" style="border-left:none;">
                    ...
                    <ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-closer">
                        ...
                        <?php endif; if(cmf_auth_check(cmf_get_current_admin_id(),'admin/admin/userinfo')): ?>
                            <li>
                                <a href="javascript:openapp('<?php echo url('admin/userinfo'); ?>','index_userinfo','<?php echo lang('ADMIN_USER_USERINFO'); ?>');"><i
