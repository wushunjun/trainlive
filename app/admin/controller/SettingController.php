...
class SettingController extends AdminBaseController
{
    ...
    public function site()
    {
        ...
        $options = cmf_get_option('site_info');
        if(isset($options['about_us']))
            $options['about_us'] = htmlspecialchars_decode($options['about_us']);
        if(isset($options['join_us']))
            $options['join_us'] = htmlspecialchars_decode($options['join_us']);
        if(isset($options['task']))
            $options['task'] = htmlspecialchars_decode($options['task']);
        if(isset($options['product']))
            $options['product'] = htmlspecialchars_decode($options['product']);
        $this->assign($options);
    ...
    public function site2()
    {
        ...
        $this->assign("admin_settings", $adminSettings);
        $this->assign("cmf_settings", $cmfSettings);
        $fetch = $this->request->param('fetch');
