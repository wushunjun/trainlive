;(function () {
    document.write("<script src='/static/js/new_noty/modernizr.custom.js'><\/script>");
    document.write("<script src='/static/js/new_noty/classie.js'></script>");
    document.write("<script src='/static/js/new_noty/notificationFx.js'></script>");
    function notice(msg){
...
function uploadMultiImage(dialog_title, container_selector, item_tpl_wrapper_id, extra_params, app) {
    openUploadDialog(dialog_title, function (dialog, files) {
        ...
        $.each(files, function (i, item) {
            ...
            itemtpl     = itemtpl.replace(/\{filepath\}/g, item.preview_url);
...
function changeTableVal(table,id_name,id_value,field,obj,yes, no)
{
    ...
    $.ajax({
        url:"/index.php/Admin/Index/changeTableVal?table="+table+"&id_name="+id_name+"&id_value="+id_value+"&field="+field+'&value='+value,
        success: function(data){
            if(data == 1){
